(function ($) {
  ...
  $(function () {
    ...
    /*-------------------------------------
          Upload Image 
      -------------------------------------*/
let input = document.getElementById("upload-photo");
let image = document.getElementById("viewImage")
input.addEventListener("change", ()=>{
  let inputImage = document.querySelector("input[type=file]").files[0];
  image.innerText = inputImage.name;
})
let file1 = document.getElementById("file1")
input.addEventListener("change", ()=>{
  let inputImage = document.querySelector("input[type=file]").files[0];
  file1.innerText = inputImage.name;
})
let file2 = document.getElementById("file2")
input.addEventListener("change", ()=>{
  let inputImage = document.querySelector("input[type=file]").files[0];
  file2.innerText = inputImage.name;
})
let file3 = document.getElementById("file3")
input.addEventListener("change", ()=>{
  let inputImage = document.querySelector("input[type=file]").files[0];
  file3.innerText = inputImage.name;
})
